...
export const HammerIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M13.5 2L2 13.5 6.5 18 18 6.5 13.5 2z"></path>
    <path d="M6 18l-4 4"></path>
...
export const TerminalSquareIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polyline points="9 10 13 14 9 18"></polyline>
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
  </svg>
);
...
export const PuzzleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M19.439 15.424a1 1 0 0 0-1.439 0l-2.062 2.063a1 1 0 0 1-1.414 0 1 1 0 0 1 0-1.415l2.063-2.062a1 1 0 0 0 0-1.439l-4.563-4.563a1 1 0 0 0-1.439 0l-2.062 2.063a1 1 0 0 1-1.415 0 1 1 0 0 1 0-1.414l2.063-2.062a1 1 0 0 0 0-1.439L6.5 2.5a1 1 0 0 0-1 0L2.5 5.5a1 1 0 0 0 0 1l3.063 3.062a1 1 0 0 0 1.439 0l2.062-2.063a1 1 0 0 1 1.415 0 1 1 0 0 1 0 1.414l-2.063 2.063a1 1 0 0 0 0 1.439l4.563 4.562a1 1 0 0 0 1.439 0l2.062-2.062a1 1 0 0 1 1.414 0 1 1 0 0 1 0 1.414l-2.062 2.062a1 1 0 0 0 0 1.439l2.5 2.5a1 1 0 0 0 1.414 0l3-3a1 1 0 0 0 0-1.414l-2.5-2.5z"></path>
  </svg>
);
...
export const BarChartHorizontalIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
